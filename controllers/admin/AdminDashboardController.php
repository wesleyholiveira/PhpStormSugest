...
class AdminDashboardControllerCore extends AdminController
{
	...
	public function renderView()
	{
		...
		$calendar_helper->setDateFrom(Tools::displayDate(Tools::getValue('date_from', $this->context->employee->stats_date_from)));
		$calendar_helper->setDateTo(Tools::displayDate(Tools::getValue('date_to', $this->context->employee->stats_date_to)));

		$stats_compare_from = $this->context->employee->stats_compare_from;
		$stats_compare_to = Tools::displayDate($this->context->employee->stats_compare_to);
		...
		$this->tpl_view_vars = array(
			'date_from' => Tools::displayDate($this->context->employee->stats_date_from),
			'date_to' => Tools::displayDate($this->context->employee->stats_date_to),
